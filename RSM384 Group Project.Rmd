...
```{r}
fit.elite <- glm(DEFNDR ~ HGT + WGT + BAR + PAN + LPVERT + SPRINT, data = nba.9624.logit, family = "binomial")    
...
```{r}
#logistic regression
fit.average <- glm(ELITE ~ HGT + WGT + BAR + PAN + LPVERT + SPRINT, data = nba.9624.logit, family = "binomial")    
...
```{r}
#logistic regression
fit.bad <- glm(TERRIBLE ~ HGT + WGT + BAR + PAN + LPVERT + SPRINT, data = nba.9624.logit, family = "binomial")    
